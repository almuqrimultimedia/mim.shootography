...
async function downloadStudioPackage(account) {
  ...
  const assetFiles = [...Array.from({ length: 12 }, (_, index) => `assets/portfolio-${String(index + 1).padStart(2, "0")}.jpg`), "assets/logo.png", "assets/favicon.png", "assets/share-preview.png"];
